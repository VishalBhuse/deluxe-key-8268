        ...
        <Box w="65%" >
          ...
          <Center>
            <Box bg="pink">
              <Image
                height={"80vh"}
                src="https://apollo-singapore.akamaized.net/v1/files/tfch2xsn8uwe1-IN/image;s=780x0;q=60"
              />
            </Box>
          </Center>

          </Box>
          <Box p="18px" mt="1px" bg="#fff" border="1px solid rgba(14, 4, 5, 0.2)">
          <Text mt="5px" fontSize={"19px"} fontWeight={'700'}>
              ...
              <VStack mt="1rem" fontSize="14px" spacing={'15px'} alignItems={'flex-start'}>
              <Text>Brand</Text>
              <Text>Samsung</Text>
              </VStack>
          </Box>
        ...
        <Box w="35%" p="0px 1rem" bg>
          ...
          >
            ...
            <HStack
              ...
              p="10px 0px"
            >
              <Text> KPHB, Hyderabad, Telangana</Text>
              <Text>day3</Text>
            </HStack>
          </Box>
